...
class FrontendAjaxRegister
{
    ...
    private static $_ajaxActions = [
        // "unifi_get_client_info" => "get-client-info-ajax.php",
    ];

    /**
     * Initialize the AJAX actions by registering them.
     *
     * This method hooks the AJAX actions into WordPress to handle both authenticated
